...
def home():
    return jsonify({
        "message": "Merged REIT Occupancy Rate + Fundamentals API",
        "endpoints": {
            ...
            "GET /fundamental?ticker=XXX&metric=YYY": "Get fundamental metric for ticker"
        },
        "examples": {
            "occupancy": "/api/occupancy/STAG",
            "fundamental": "/fundamental?ticker=JPM&metric=P/E"
        }
    })
